...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 // `-----------------------------------------------------------------------------------------------------------------------------'
    ...
    [_ADJUST] = LAYOUT(
 // ,-----------------------------------------------------.                 ,-----------------------------------------------------.
      QK_BOOT, _______, _______, _______,  QWERTY,    BASE,                  POWER, _______, _______, _______, _______, _______,
 // |--------+--------+--------+--------+--------+--------|                 |--------+--------+--------+--------+--------+--------|
 ...
 // |--------+--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------+--------|
      KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, _______,  TENKEY,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_BSLS,
 // |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
      KC_LSFT, _______, KC_LCTL, KC_LGUI, MHENKAN,   LOWER,  KC_SPC,  KC_ENT,   RAISE,  HENKAN, KC_RALT, KC_RSFT, _______ , KC_BSLS
 // `-----------------------------------------------------------------------------------------------------------------------------'
   ) //,
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_NAGINATA] = { ENCODER_CCW_CW(KC_MS_WH_UP, KC_MS_WH_DOWN),    ENCODER_CCW_CW(KC_VOLD, KC_VOLU)  },
    ...
    [_10KEY] = { ENCODER_CCW_CW(KC_MS_WH_UP, KC_MS_WH_DOWN),    ENCODER_CCW_CW(KC_VOLD, KC_VOLU)  } //,
